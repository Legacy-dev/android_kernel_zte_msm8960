...
static unsigned bt_config_power_on[] = {
	GPIO_CFG(MSM2BT_WAKE, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* WAKE */ //gsbi11 
...
static unsigned bt_config_power_off[] = {
	GPIO_CFG(MSM2BT_WAKE, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* WAKE */ //gsbi11 
...
#ifdef CONFIG_ISPCAM //wt 2012-04-19
...
struct pn544_i2c_platform_data pn544_data={
       .irq_gpio=106,
       .ven_gpio=PM8921_GPIO_PM_TO_SYS(7),  //pm8921_gpio7
 ...
 */
	...
	msm8960_init_hsic();
	#ifdef CONFIG_MSM_CAMERA//added by CDZ_CAM_ZTE
	msm8960_init_cam();
	#endif
	msm8960_init_mmc();
	acpuclk_init(&acpuclk_8960_soc_data);
