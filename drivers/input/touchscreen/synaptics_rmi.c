...
//#include <linux/ktime.h>//xym
//#include <linux/time.h>//xym
//#endif
...
#ifdef CONFIG_TOUCHSCREEN_RESUME_LOG//xym
typedef struct {
...
DECLARE_BITMAP(pre_pre_fingers, NR_FINGERS);
#endif
...
#ifdef CONFIG_TOUCHSCREEN_RESUME_LOG
	bitmap_zero(pre_pre_fingers, NR_FINGERS);//xym
#endif
