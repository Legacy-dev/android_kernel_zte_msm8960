...
static char truly_cmd_C51[] = {0xC5, 0x10,0x6F,0x02,0x88,0x1d,0x15,0x00,0x04};
static char truly_shift_C52[] = {0x00, 0xa0};
static char truly_cmd_C52[] = {0xC5, 0x10,0x6F,0x02,0x88,0x1d,0x15,0x00,0x04};
static char truly_shift_C53[] = {0x00, 0x80};
static char truly_cmd_C53[] = {0xC5, 0x20,0x01,0x00,0xB0,0xB0,0x00,0x04,0x00};
...
//		{DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(truly_cmd_35),truly_cmd_35},
		...
		{DTYPE_DCS_WRITE, 1, 0, 0, 1, sizeof(truly_cmd_2c),truly_cmd_2c},
	
		{DTYPE_DCS_WRITE, 1, 0, 0, 1, sizeof(truly_cmd_3c), truly_cmd_3c},
...
static char cmi_cmd_C5_80[] = {0xc5,0x20,0x07,0x00,0xb0,0xb0,0x00,0x6c,0x00};
static char cmi_shift_C5_90[] = {0x00,0x90};
static char cmi_cmd_C5_90[] = {0xc5,0x30,0x85,0x02,0x88,0x96,0x15,0x00,0x0c,0x44,0x44,0x44};
...
static int mipi_lcd_on(struct platform_device *pdev)
{
	...
	printk("lizhiye, mipi_lcd_on , LcdPanleID = %d\n", LcdPanleID);
	...
	{				
		case LCD_PANEL_4P3_OTM1280_OT_CMI:	//310
			printk("lizhiye, LCD_PANEL_4P3_OTM1280_OT_CMI\n");
