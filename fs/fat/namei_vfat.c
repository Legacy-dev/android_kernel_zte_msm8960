...
static int vfat_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_ERR"jzq vfat_rmdir %d name %s\n",  __LINE__,dentry->d_name.name);
out:
	unlock_super(sb);
...
static int vfat_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_ERR"jzq vfat_unlink %d name %s\n",  __LINE__,dentry->d_name.name);
		       ...
		       struct inode *new_dir, struct dentry *new_dentry)
{
	...
	printk(KERN_ERR"jzq vfat_rename %d new name %s\n",  __LINE__,new_dentry->d_name.name);
out:
	brelse(sinfo.bh);
	brelse(dotdot_bh);
	brelse(old_sinfo.bh);
